...
<div class="container_upper">
	<div class="container">
		<div class="row">
			<div class="col-md-4 text-center  wow pulse" data-wow-offset="200" data-wow-duration="1s">
			...
			<div class="col-md-4 text-center wow pulse" data-wow-offset="200" data-wow-delay="1s"
			...
			<div class="col-md-4 text-center   wow pulse" data-wow-offset="200" data-wow-delay="2s"
			     data-wow-duration="1s">
...
<div class="container3">
	<div class="container">
		...
		<div class="featurette">
			<img class="featurette-image img-circle pull-right wow bounceInRight" data-wow-offset="200"
			     src="<?= Url::to( '@web/img/index/06.jpg' ); ?>">
...
<div class="container2">
	<div class="container">
		<!-- START THE FEATURETTES -->
		<div class="featurette">
			<img class="featurette-image img-circle pull-left wow bounceInLeft" data-wow-offset="200"
			     src="<?= Url::to( '@web/img/index/05.jpg' ); ?>">
...
<div class="container2">
	<aside class="container">
		<div class="">
			<div class="featurette">
				<h2 class="featurette-heading text-center">Наші партнери: </h2>
				<br>
				<br>
				<div class="row ">
					...
					<div class="col-md-3 col-sm-6">
						<a href="http://upec.ua/">
							<img src="/img/upec.png" class="img-responsive img-centered" alt="">
						</a>
					</div>
					<div class="col-md-3 col-sm-6 ">
						<a href="http://lkmz.com/">
							<img src="/img/lkmz_white.png" class="img-responsive img-centered" alt="">
						</a>
					</div>
				</div>
			</div>
