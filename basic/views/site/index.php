      ...
      <div class="row">
        <div class="col-md-4 text-center">
          ...
          <p>Викладачі кафедри беруть активну участь у виданні підручників, посібників, 
            методичних вказівок і наукових праць. Навчальний процес забезпечений кафедральними науково-методичними розробками. 
            ...
            «Мобільні енергетичні засоби», «Машиновикористання в землеробстві», «Машиновикористання та екологія довкілля», 
            «Будова і технічне обслуговування тракторів і автомобілів», «Деталі машин. Курсове проектування» та ін.</p>
          <p><a class="btn btn-default" href="<?= Url::to(['/static-page/view-alias', 'alias' => 'metod_work']); ?>">Далі ... &raquo;</a></p>
        </div>
        <div class="col-md-4 text-center">
...
<div class="container3">
 ...
 <!-- START THE FEATURETTES --> 
        ...
        <h2 class="featurette-heading">Абітурієнтам: <span class="text-muted">наша кафедра – Ваш правильний вибір!</span></h2>
        <p class="lead">Кафедра здійснює підготовку фахівців інженерної служби 
                    ...
                    «бакалавр», «спеціаліст» і «магістр» за спеціальністю «Процеси, машини та обладнання агропромислових підприємств»</p>
        <p><a class="btn btn-default" href="<?= Url::to(['/static-page/view-alias', 'alias' => 'zvernennya']); ?>">Далі ... &raquo;</a></p>
        </div>
  <!-- /END THE FEATURETTES -->  
  </div> 
</div>
...
<div class="container2">
 ...
 <!-- START THE FEATURETTES -->
        ...
        <h2 class="featurette-heading">Студентам:  <span class="text-muted">Все що потрібнно для якісної освіти </span></h2>
        <p class="lead"> На кафедрі викладається понад 30 навчальних дисциплін, а також здійснюється підготовка водіїв категорії «В». 
        У навчальному процесі використовуються лекційні аудиторії, комп’ютеризовані класи, спеціалізовані лабораторії, 
        а також сільськогосподарські машини та обладнання, призначені для виконання різних механізованих технологічних операцій у 
