    ...
    <div class="col-md-9">
        ...
        <div class="panel-group" id="accordion">
            <div class="panel panel-default">
                ...
                <div class="panel-collapse collapse" id="collapseOne">
                    <div class="panel-body">
                        <div class="row">
                            <div class="col-md-12">
                                <?= Html::a( 'Переглянути всі отримані повідомлення', [ '/message/' ],
                                    [ 'class' => 'btn btn-default pull-left' ] ) ?>
                                <?= Html::a( 'Написати повідомлення викладачу', [ '/message/create' ],
            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h4 class="panel-title">
                        <a class="accordion-toggle" href="#collapseThree" data-toggle="collapse"
                ...
                <div class="panel-collapse collapse" id="collapseThree">
                    <div class="panel-body">
                        ...
                        <div class="col-md-3">
                            <?= Html::a( 'Створити методичку', [ '/metodychky/create' ],
                                [ 'class' => 'btn btn-success' ] ) ?>
                        </div>
                    </div>
                </div>
            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h4 class="panel-title">
                        <a class="accordion-toggle" href="#collapseFour" data-toggle="collapse"
                           data-parent="#accordion">
                            Особисті новини
                        </a>
                <span class="pull-right">Всього: 
                ...
                <div class="panel-collapse collapse" id="collapseFour">
                    <div class="panel-body">
                        ...
                        <div class="col-md-3">
                            <?= Html::a( 'Створити новину', [ '/teacher-news/create' ],
                                [ 'class' => 'btn btn-success' ] ) ?>
                        </div>
                    </div>
                </div>
            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h4 class="panel-title">
                        <a class="accordion-toggle" href="#collapseFive" data-toggle="collapse"
                           data-parent="#accordion">
                ...
                <div class="panel-collapse collapse" id="collapseFive">
                    <div class="panel-body">
                        <div class="row">
                            <?= Html::a( 'Переглянути всі надіслані повідомлення', [ '/message/ownmessage' ],
                                [ 'class' => 'btn btn-default pull-left' ] ) ?>
                            <?= Html::a( 'Створити повідомлення', [ '/message/create' ],
                                [ 'class' => 'btn btn-success pull-right' ] ) ?>
                        </div>
                        <br/>
                        <?= ListView::widget( [
