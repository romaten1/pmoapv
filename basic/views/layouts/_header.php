    ...
    'items'   => [
        [
            ...
            'items' => [
                ...
                [
                    'label' => 'Практична підготовка студентів',
                    'url'   => [ '/static-page/view-alias', 'alias' => 'praktika' ]
                ],
        ...
        [
            ...
            'items' => [
                [
                    'label' => 'Напрямки наукових досліджень викладачів кафедри',
                    'url'   => [ '/static-page/view-alias', 'alias' => 'napryamy-nauki' ]
                ],
                [
                    'label' => 'Наукова робота студентів',
                    'url'   => [ '/static-page/view-alias', 'alias' => 'student_work' ]
                ],
        ...
        ! Yii::$app->user->isGuest ?
            [ 'label' => 'Звернутись до адміністратора сайту', 'url' => ['/message/user-message', 'receiver_id' => 2]  ] : '',
