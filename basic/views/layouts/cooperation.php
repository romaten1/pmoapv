<?php
use app\assets\CooperationAsset;
...
/* @var $content string */
CooperationAsset::register( $this );
AppAsset::register( $this );
MainPageAsset::register($this);

$this->title = 'Співпраця з виробництвом';
?>
<?php $this->beginPage() ?>
        ...
        <div class="container">
            ...
            <div class="row text-center">
                <div class="col-md-4 wow bounceIn" data-wow-delay="1s">
                    ...
                    <p class="text-muted">Напрям підготовки 6.100102 Процеси, машини та обладнання агропромислового
                        виробництва</p>
                </div>
                            ...
                            <div class="timeline-panel">
                                ...
                                <div class="timeline-body">
                                    <p class="text-muted">в Уманський національний університет садівництва на напрям
                                        підготовки 6.100102 Процеси, машини та обладнання агропромислового виробництва і
                            ...
                            <div class="timeline-panel">
                                ...
                                <div class="timeline-body">
                                    <p class="text-muted">Розуміючи потребу подальшого власного розвитку і прагнучи
                                        ...
                                        напрямок наукової роботи і успішно захищаєте магістерську роботу.</p>
                                </div>
                            </div>
                        </li>
                        <li class="timeline-inverted">
