        ...
        <?php
            ...
            echo Nav::widget([
                ...
                'items' => [
                    ['label' => 'Про кафедру',
                        'items' => [
                            ['label' => 'Про кафедру', 'url' => ['/kafedra/about']],
                            ['label' => 'Історія кафедри', 'url' => ['/kafedra/history']],
                            ['label' => 'Викладацький склад', 'url' => ['/kafedra/teachers']],
                            ['label' => 'Методична робота', 'url' => ['/kafedra/metod_work']],
                            ['label' => 'Організацйна робота', 'url' => ['/kafedra/org_work']],
                            ['label' => 'Практична підготовка студентів', 'url' => ['/kafedra/praktika']],
                            ['label' => 'Навчальні лабораторії', 'url' => ['/kafedra/laboratory']],
                            ['label' => 'Матеріально-технічна база', 'url' => ['/kafedra/mattehbaza']],
