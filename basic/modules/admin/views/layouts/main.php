    ...
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <div class="col-xs-2">
                ...
                <div class="panel panel-primary">
                    <div class="panel-heading"><h3 class="panel-title"><?= Html::a( 'Новини',
                                [ '/admin/news' ] ) ?></h3></div>
                    <div class="panel-body">
                ...
                <div class="panel panel-primary">
                    <div class="panel-heading"><h3 class="panel-title"><?= Html::a( 'Статичні сторінки',
                                [ '/admin/static-page' ] ) ?></h3></div>
                    <div class="panel-body">
                ...
                <div class="panel panel-primary">
                    <div class="panel-heading"><h3 class="panel-title"><?= Html::a( 'Викладачі',
                                [ '/admin/teacher' ] ) ?></h3></div>
                    <div class="panel-body">
                ...
                <div class="panel panel-primary">
                    <div class="panel-heading"><h3 class="panel-title"><?= Html::a( 'Предмети',
                                [ '/admin/predmet' ] ) ?></h3></div>
                    <div class="panel-body">
                ...
                <div class="panel panel-primary">
                    <div class="panel-heading"><h3 class="panel-title"><?= Html::a( 'Наукові заходи',
                                [ '/admin/conference' ] ) ?></h3></div>
                    <div class="panel-body">
